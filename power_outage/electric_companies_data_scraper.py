...
while True:
    for company in companies:
        ...
        download_data_from_url(company = company, output_javascript_file = 'data/company.js' )

        # Transform javascript file to python
        transform_js_to_py(input_javascript_file = 'data/company.js',output_python_file = 'company.py')
